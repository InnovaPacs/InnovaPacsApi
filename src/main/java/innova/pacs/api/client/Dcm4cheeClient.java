...
public class Dcm4cheeClient {
	...
	public void updateStudies() {
		String updateUrl = String.format("http://%s:%s/dcm4chee-arc/aets/INNOVA_DCM4CHEE/rs/studies", this.host, this.apiPort);
...
//		https://192.168.3.108:8443/dcm4chee-arc/aets/DCM4CHEE/rs/studies/1.2.392.200036.9125.2.20839136157173252.64951091883.41568/export/dicom:DCM4CHEE?
		String url = String.format("http://%s:%s/dcm4chee-arc/aets/INNOVA_DCM4CHEE/rs/studies/%s/export/dicom:%s?", this.host,
